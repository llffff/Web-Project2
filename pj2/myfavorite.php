...
require_once "./PHP/favourite_logic.php";
?>
<head>
    <meta charset="UTF-8">

    <title>Pics Store | 我的收藏</title>
...
<?php
include_once "./PHP/query_delete.php"?>
<!--script>
    ...
    function doDelete(obj) {
        ...
        $.post("./PHP/query_delete.php",{"iid": iid},function (data) {
            alert("ss");
            if(data.status){
                var href_script_name = data.href_script_name;
