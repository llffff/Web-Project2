        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form method="post" id="upload_form" class="upload-form" enctype="multipart/form-data">
                        <div class="upload_file">
                            ...
                            <input type="button" class="btn btn-default" id="upload_button" onclick="input.click();"
                                   value="上传图片" <?php if(!isset($_GET['iid'])) echo 'onblur=checkPath()' ?>onblur=checkPath()><span id="pathSpan"> </span>
